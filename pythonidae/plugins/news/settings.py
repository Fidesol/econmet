...
NEWS_FLUENT_DASHBOARD_APP_GROUPS = (_('News Plug-in'), {
                                            'models': (
                                            'plugins.news.models.New',
                                            ),
...
NEWS_FLUENT_DASHBOARD_APP_ICONS = {
    'news/new': 'images/admin/admin_news.png',
}
